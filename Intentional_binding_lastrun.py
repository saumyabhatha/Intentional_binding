...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\AU\\PSY310\\Intentional_binding\\Intentional_binding_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor=[-1.0000, 0.0039, -1.0000],
